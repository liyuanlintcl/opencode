export const dict = {
  ...
  "command.omniStudio.open": "Open Omni Studio",
  ...
  "omniStudio.searchPlaceholder": "Search extensions...",
  "omniStudio.categories.all": "All",
  "omniStudio.categories.skill": "Skills",
  "omniStudio.categories.agent": "Agents",
  "omniStudio.categories.command": "Commands",
  "omniStudio.categories.tool": "Tools",
  "omniStudio.categories.plugin": "Plugins",
  "omniStudio.filters.title": "Filters",
  "omniStudio.installed": "Installed",
  "omniStudio.enabled": "Enabled",
  "omniStudio.results": "results",
  "omniStudio.emptyState": "No extensions found",
  "omniStudio.selectItem": "Select an extension to view details",
  "omniStudio.actions.install": "Install",
  "omniStudio.actions.uninstall": "Uninstall",
  "omniStudio.actions.enable": "Enable",
  "omniStudio.actions.disable": "Disable",
  ...
  "omniStudio.login.cancel": "Cancel",
  "omniStudio.login.loading": "Logging in...",
  "omniStudio.detail.description": "Description",
  "omniStudio.project.overrideTitle": "Project Configuration",
