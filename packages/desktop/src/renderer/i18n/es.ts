export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de {{brand}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de {{brand}}. ¿Quieres instalarla y reiniciar?",
